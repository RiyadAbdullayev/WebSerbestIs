    ...
    <>
      <div className="project-card group rounded-lg border border-lightBorder bg-white py-5 dark:border-darkBorder dark:bg-blue-300/5 mm:px-6 lg:px-10">
        <div className="grid grid-cols-12 items-center">
          ...
          <div className="w-full h-64 overflow-hidden rounded-md mm:col-span-12 lg:col-span-6">
            <img
              src={item.project_img}
              alt=""
              className="w-full h-full object-cover transition-all duration-[.8s] group-hover:scale-110"
            />
          </div>
        </div>
      </div>
