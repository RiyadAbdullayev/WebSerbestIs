...
const VITE_SERVICE_ID = "service_8n54f1x"
const VITE_PUBLIC_KEY = "pXTCAD3h41o3cZLda"
const VITE_TEMPLATE_ID = "template_iqfpsxf"
...
const ContactForm = () => {
  ...
  const SERVICE_ID = VITE_SERVICE_ID;
  const TEMPLATE_ID = VITE_TEMPLATE_ID;
